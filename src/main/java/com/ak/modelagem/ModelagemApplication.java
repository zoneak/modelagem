...
public class ModelagemApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat6 = new Categoria(null, "Organização");
		...
		cli1.getTelefones().addAll(Arrays.asList("55551234", "999991234"));
		...
		PagamentoComBoleto pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("20/10/2021 00:00"), null);
