...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Admin", "adriano.kaito@gmail.com", "21591213045", TipoCliente.PESSOA_FISICA, bCryptPasswordEncoder.encode("1234"));
		cli1.getTelefones().addAll(Arrays.asList("44441234", "999991234"));
		cli1.addPerfil(Perfil.ADMIN);

		Cliente cli2 = new Cliente(null, "Maria Silva", "zoneak@gmail.com", "36378912377", TipoCliente.PESSOA_FISICA, bCryptPasswordEncoder.encode("1234"));
		cli2.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Endereco e1 = new Endereco(null, "Av Kennedy", "100", "DTI", "Centro", "38777013", cli1, c2);
